...
<!--(bake module/headerend.html)--><?php require_once('publicpage/headerend.php'); ?>
	...
	<div class="cart-body_28">
		...
		<div class="cart1-pc_28">
			...
			<div class="total_28">
				<div class="total-sum">
					<p>共<span class="total-num PC-num"></span>項商品，總金額<span class="total-money PC-total"></span>元</p>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
		...
		<div class="cart1-phone_28">
			...
			<div class="total-phone" >
				<p>共<span class="total-num num_phone"></span>項商品，總金額<span class="total-money total_phone"></span>元</p>
			</div>
		</div><!--cart1-phone_28-->
	...
	<div class="order-over_31">
		...
		<div class="Order-box">
			...
			<div class="give-money">
				<div class="giveInfo">
					<ul>
						<li><h3 class="give-sp-item1">戶名</h3><span class="give-sp-item2">酋長衝浪</span></li>
